...
const forgotPassword = asyncHandler(async (req, res) => {
    ...
    const html=`Xin vui lòng click vào link dưới đây để thay đổi mật khẩu của bạn. Link sẽ hết hạn sau 15 phút kể từ bây giờ. <a href=${process.env.URL_SERVER}/api/user/reset-password/${resetToken}>Click here</a>`
    const data={
      email: email,
      html
    }
...
const updateCart= asyncHandler(async(req,res)=>{
  ...
  const alreadyProduct = user?.cart?.find(el=> el.product.toString() ===product)
